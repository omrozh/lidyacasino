...
games_and_descriptions = {
    ...
    "up_or_down": "In this Plutus original you try to guess if the next number is going to be higher or "
                  ...
                  "advantage.",
    "limbo": "Limbo seçtiğiniz çarpanın üzerinde mi yoksa altında mı çarpan geleceğini tahmin ettiğiniz bir Lidya Casino özel oyunudur.",
    ...
    "double": "Double paranızı ikiye katlayabileceğiniz yüksek adrenelinli bir Lidya Casino orijinal oyunudur."
...
app.config["CASINO_BASE_URL"] = "http://172.233.245.62/casino-callback/"
...
class User(db.Model, UserMixin):
    ...
    def send_password_reset_email(self, current_domain):
        msg = Message(
            'Lidya Casino şifre sıfırlama talebi ',
...
@app.route("/api/py/", methods=["POST", "GET"])
